 ...
 * through normalise before it becomes the store: garbage or any version but the current one comes
 * out as the default store at SCHEMA_VERSION, and a current store comes out untouched. No migration
 * chain is asserted here; it arrives with the first real migration. Run standalone (`node verify-store.mjs`) or via
